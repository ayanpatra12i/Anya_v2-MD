...
module.exports = {
    ...
    ownernumber: process.env.Owner_Number || "918101400579",
    instagramId: process.env.Insta || "Crazy_Ayan_6294",
    ...
    sessionId: process.env.SESSION_ID || "JF2i7_A_N_Y_A_V_2_7ROc9ni9BjzGVOw",
